...
class VelvetPopUp:
    def __init__(self, master):
        ...
        ttk.Label(frame, text="Velvet", style="N.TLabel").grid(row=rowcount, columnspan=2, sticky='w')
        rowcount += 1
        ...
        ttk.Label(self.paramFrame, text='Input file format:', style="P.TLabel").grid(row=1, column=0, sticky='e')
    ...
    def runScript(self):
        ...
        try:
            ...
            if tmpKmer<15 or tmpKmer>64:
                ...
                print("dic" + tmpDic)
                print("files1" + tmpFiles1)
                print("files2" + tmpFiles2)
                
                if tmpDic == '':
                    subprocess.run(["../velvet/velveth", ".", str(tmpKmer), "-fastq", "-short", tmpFiles2])
                    print("ok")
                #else:
